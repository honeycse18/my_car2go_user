...
import 'package:car2gouser/screens/bottomsheet_screen/confirm_bottom_sheet.dart';
                                      ...
                                      child: ScaffoldBodyWidget(
                                        ...
                                        slivers: [
                                          ...
                                          SliverToBoxAdapter(
                                            ...
                                            callTap: () async {
                                              final didSuccessfullyOpenCall =
                                                  await Helper.openPhoneNumber(
                                                      controller.rideDetails
                                                          .driver.phone);
                                              if (didSuccessfullyOpenCall ==
                                                  false) {
                  ...
                  child: PhysicalModel(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            left: 16.0, top: 15, right: 16, bottom: 12),
                        child: Column(
                          children: [
                            Row(
                                mainAxisAlignment:
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${Helper.getCurrencyFormattedWithDecimalAmountText(10)}',
                                        maxLines: 1,
                            ...
                            Column(
                              ...
                              children: [
                                CustomStretchedButtonWidget(
                                  ...
                                  onLongPress: () {
                                    ...
                                    Get.bottomSheet(ConfirmBottomSheet(
                                      ...
                                      noButtonText: 'No, Keep Ride',
                                      yesButtonText: 'Yes, Cancel',
                                      noButtonTap: controller.NobuttonTap,
                                      yesButtonTap: controller.YesbuttonTap,
                                    ));
                                  },
                                  child: Text('Ride Now'),
                                ),
                                // CustomStretchedButtonWidget(
                                //   isLoading: controller.isLoading,
                                //     onTap: controller.shouldEnableBottomButton

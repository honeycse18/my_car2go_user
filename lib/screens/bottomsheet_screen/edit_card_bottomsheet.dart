import 'package:car2gouser/controller/dialogs/edit_card_bottomsheet_controller.dart';
...
class EditCardBottomsheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<EditCardBottomsheetController>(
        init: EditCardBottomsheetController(),
        builder: (controller) {
          return Padding(
